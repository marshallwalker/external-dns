...
| external_dns_controller_verified_cname_records           | Number of DNS CNAME-records that exists both in source and registry | Gauge   |
...
| external_dns_registry_cname_records                      | Number of CNAME records in registry                                 | Gauge   |
...
| external_dns_source_cname_records                        | Number of CNAME records in source                                   | Gauge   |
